...
QT_MOC_LITERAL(1, 21, 20), // "configurationChanged"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 7) // "setting"

    },
    "ConfigurationManager\0configurationChanged\0"
    "\0setting"
};
...
void ConfigurationManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ConfigurationManager *_t = static_cast<ConfigurationManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ConfigurationManager::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConfigurationManager::configurationChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ConfigurationManager::configurationChanged(const QString & _t1)
{
