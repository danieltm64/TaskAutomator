...
QT_MOC_LITERAL(1, 9, 24), // "doubleClickedOnBlankArea"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 22) // "doubleClickedOnOneTask"

    },
    "TaskList\0doubleClickedOnBlankArea\0\0"
    "doubleClickedOnOneTask"
};
...
void TaskList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TaskList *_t = static_cast<TaskList *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->doubleClickedOnBlankArea(); break;
        case 1: _t->doubleClickedOnOneTask(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskList::doubleClickedOnBlankArea)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TaskList::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskList::doubleClickedOnOneTask)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TaskList::doubleClickedOnBlankArea()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void TaskList::doubleClickedOnOneTask()
{
